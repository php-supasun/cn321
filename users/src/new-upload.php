    ...
    <div class="container">
        <form method="POST" action="update-profile-action.php" enctype="multipart/form-data">
            <div class="col-md-10" style="margin: 50px auto 0 auto;">
                ...
                <input type="hidden" name="fullname" value="<?php echo $user_data['full_name'] ?>" class="form-control"/>
                <input type="hidden" name="age" value="<?php echo $user_data['age'] ?>" class="form-control"/>
                <input type="hidden" name="gender" value="<?php echo $user_data['gender'] ?>" class="form-control"/>
                <input type="hidden" name="address" value="<?php echo $user_data['address'] ?>" class="form-control"/>
                <input type="hidden" name="test" value="<?php echo $user_data['test'] ?>" class="form-control"/>
